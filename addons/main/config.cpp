	...
	class DRNP_AL6_Antimine: UAV_06_antimine_base_F {
		...
		class SimpleObject {
			...
			animate[] = {
				...
				{"propeller5_rotation", 0},
				{"propeller5_blur_rotation", 0},
				{"propeller6_rotation", 0},
				{"propeller6_blur_rotation", 0},
				{"propeller1_hide", 0},
				...
				{"lights_em_1", 901.08002},
				{"lights_em_2", 901.08002},
				{"lights_em_1_flash", 901.08002},
				{"lights_em_2_flash", 901.08002}
			};
			hide[] = {
				"zasleh",
				"tail rotor blur",
	...
	class DRNP_AL6_MED: B_UAV_06_medical_F {
		...
		class SimpleObject {
			...
			animate[] = {
				...
				{"propeller6_hide", 0},
				{"propeller6_blur_hide", 0},
				{"lights_em_1", 700.84998},
				{"lights_em_2", 700.84998},
				{"lights_em_1_flash", 700.84998},
				{"lights_em_2_flash", 700.84998}
			};
			hide[] = {
				"zasleh",
				"tail rotor blur",
	...
	class DRNP_AL6: UAV_06_base_F {
		...
		class SimpleObject {
			...
			animate[] = {
				...
				{"lights_em_1", 698.25},
				{"lights_em_2", 698.25},
				{"lights_em_1_flash", 698.25},
				{"lights_em_2_flash", 698.25}
			};
			hide[] = {
				"zasleh",
				"tail rotor blur",
